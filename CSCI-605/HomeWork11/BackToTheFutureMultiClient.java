package HomeWork11;
/*
 *  BackToTheFutureMultiClient.java
 * 
 *  Version: BackToTheFutureMultiClient.java, v 1.0 2017/17/11
 *  
 *  Revisions:
...
public class BackToTheFutureMultiClient {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		//Reading the new port location from the server
		BufferedReader bufferedReader = new BufferedReader( new InputStreamReader ( socket.getInputStream() ) );
		String newPort = bufferedReader.readLine ();
