 ...
 *  MyHashSet.java
 * 
 *  Version: MyHashSet.java, v 1.0 2017/01/10
 *  
 *  Revisions:
...
public class  MyHashSet extends MyStorage {
	MyFixedList myFixedList;
	
	public MyHashSet() {
		myFixedList = new MyFixedList();
		for( int i = 0; i < myFixedList.fixedList.length; i++ ) {
			myFixedList.add( new MyList() ) ;
		}
	}
  ...
  // class name;
   public String getClassName() {
    ...
    public static void main(String args[]) {
      ...
      System.out.println("Contains : " + myHashSet.contains("Hi"));
      myHashSet.add("Hello");
      myHashSet.add("Hi");
      myHashSet.add("Rohit");
      myHashSet.add("hitRo");
      ...
      System.out.println("Contains : " + myHashSet.contains("Hi"));
      System.out.println("Adding what is already added : " + myHashSet.add("Rohit"));
      myHashSet.remove("Rohit");
      System.out.println("Contains : " + myHashSet.contains("Rohit"));
