public class TestObject {
   ...
   public <T> void testIt(MyStorage<T> aStorage)	{
	this.aStorage = (MyStorage<Object>) aStorage;
	start();
   ...
   public static void main(String args[] )	{
	...
	(new TestString()).testIt(new MyHashSet<Object>());
	System.out.println("\nMy Fixed List :-");
	(new TestString()).testIt(new MyFixedList<Object>());
	System.out.println("\nMy List :-");
	(new TestString()).testIt(new MyList<Object>());
	System.out.println("\nMy Sorted List :-");
//	(new TestInteger()).testIt(new MySortedList<Object>());
	System.exit(0);
   }
}
